...
ft_putendl_fd.c ft_striteri.c ft_strmapi.c ft_strtrim.c ft_itoa.c ft_split.c ft_strjoin.c \

OBJSBONUS = ft_lstnew.c ft_lstsize.c ft_lstadd_front.c ft_lstdelone.c ft_lstadd_back.c \
